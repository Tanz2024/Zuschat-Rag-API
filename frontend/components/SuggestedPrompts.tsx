  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
    {SUGGESTED_PROMPTS.slice(0, 8).map((promptObj, index) => (
      <button
        ...
        disabled={disabled}
        className={`p-3 sm:p-4 text-left bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl hover:border-blue-300 dark:hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-gray-700 transition-all duration-200 shadow-sm hover:shadow-md ${
      ...
      >
        <div className="text-gray-900 dark:text-white font-medium text-sm sm:text-base" style={{ fontWeight: '500', letterSpacing: '-0.011em', lineHeight: '1.5' }}>
          {promptObj.text}
        </div>
        <div className="text-gray-500 dark:text-gray-400 mt-1 sm:mt-1.5 text-xs sm:text-sm" style={{ fontWeight: '400', letterSpacing: '-0.008em', lineHeight: '1.4' }}>
          {promptObj.category}
        </div>
      </button>
    ))}
